...
#undef T
        ...
        info.emplace(std::pair{'I', 2}, op_I3);
        info.emplace(std::pair{'I', 3}, op_I4);
        info.emplace(std::pair{'S', 0}, op_S1);
        info.emplace(std::pair{'S', 1}, op_S2);
        info.emplace(std::pair{'S', 2}, op_S3);
        info.emplace(std::pair{'S', 3}, op_S4);
        info.emplace(std::pair{'Z', 0}, op_Z1);
        info.emplace(std::pair{'Z', 1}, op_Z2);
        info.emplace(std::pair{'Z', 2}, op_Z3);
        info.emplace(std::pair{'Z', 3}, op_Z4);
