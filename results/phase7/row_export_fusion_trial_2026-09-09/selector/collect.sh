...
local_dir=$repo/results/phase7/row_export_fusion_trial_2026-09-09/selector
artifact_dir=/home/icly/Documents/tetris_ai_runner_results/phase7/row_export_fusion_trial_2026-09-09/selector_artifacts
normal=$artifact_dir/tetris_profile_normal
soa=$artifact_dir/tetris_profile_row_fusion
params=$repo/artifacts/frozen_29d.bin
count_verdict=$repo/results/phase7/row_export_fusion_trial_2026-09-09/count/PARENT_VERDICT.md
...
if ! git merge-base --is-ancestor 2c75c94 "$git_head" || test -n "$(git status --porcelain --untracked-files=no)"; then
...
verify_hash 6211dd00e6b554a3338520fb4285a2c4d4c098a4db81131d11a03da3bc790a19 "$count_verdict"
