...
local_dir=$repo/results/phase7/row_export_fusion_trial_2026-09-09/count
external_dir=/home/icly/Documents/tetris_ai_runner_results/phase7/row_export_fusion_trial_2026-09-09/trace
normal=$repo/out/build/linux-gcc-self-release/tetris_profile_value
soa=$repo/out/build/linux-gcc-self-release/tetris_profile_row_fusion
partition_normal=$repo/out/build/linux-gcc-self-release/candidate_partition
partition_soa=$repo/out/build/linux-gcc-self-release/candidate_partition_row_fusion
...
if ! git merge-base --is-ancestor abf870d "$git_head" || test -n "$(git status --porcelain --untracked-files=no)"; then
...
verify_hash ce2bd5a65967772bdbb89ac25b94a009c4d189cb1396a16a38ce96c27594ee7c "$soa"
verify_hash 5986bdeebf9ff34fe4c3de0845881991fe463f6dc84dcbfb8d1b4bd7944642a1 "$partition_normal"
verify_hash 71cdadc5981465e602df066b7dfdaf73117bbe107d2aece42844f4ddeee61dd2 "$partition_soa"
verify_hash ea95ba584f4eb5a7234bf0fbdd68fb422e00e29d13373e4df9e6b9ea2ca98037 "$params"
verify_hash 5e7a7328b500b330a7b291bb6e1ea74c495dc9c3859a52e2148d0b16c7727361 "$repo/results/phase7/row_export_fusion_trial_2026-09-09/validation/prerequisite_tests_2026-09-09.txt"
...
for key in normal:
    if not timing(key) and key != "mem_retained_bytes" and normal[key] != soa[key]:
        raise SystemExit(1)
if normal["mem_retained_bytes"] != "266338276" or soa["mem_retained_bytes"] != "266338276":
    raise SystemExit(1)
PY
then
