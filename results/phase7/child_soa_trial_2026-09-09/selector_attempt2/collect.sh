...
local_dir=$repo/results/phase7/child_soa_trial_2026-09-09/selector_attempt2
artifact_dir=/home/icly/Documents/tetris_ai_runner_results/phase7/child_soa_trial_2026-09-09/selector_attempt2_artifacts
...
if ! git merge-base --is-ancestor eac8039 "$git_head" || test -n "$(git status --porcelain --untracked-files=no)"; then
