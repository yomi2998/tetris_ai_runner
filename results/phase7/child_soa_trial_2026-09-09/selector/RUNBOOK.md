# Child SoA telemetry-off selector

## Scope

This is one balanced, non-qualification telemetry-off selector of the count-gated Child SoA staging trial against the unchanged normal candidate.
...
Normal:
`/home/icly/Documents/tetris_ai_runner_results/phase7/child_soa_trial_2026-09-09/selector_artifacts/tetris_profile_normal`
SHA-256 `1dccaa808044593bd97d6e8af09848ce8b19e75b9dcefa50d63a17a6381db765`

Child SoA:
`/home/icly/Documents/tetris_ai_runner_results/phase7/child_soa_trial_2026-09-09/selector_artifacts/tetris_profile_child_soa`
...
Both executable artifacts are read-only. Verify every hash and mode before collection. Any mismatch is `BLOCKED`.
...
```text
bash /home/icly/Documents/tetris_ai_runner/results/phase7/child_soa_trial_2026-09-09/selector/collect.sh
```
...
The collector must begin from a clean tracked tree whose HEAD contains `b1ab3bc`. It verifies all four frozen hashes, artifact modes, CPU 7 governor `performance`, CPU 7 energy preference `performance`, global boost `1`, CPU 15 initially online, and noninteractive CPU-control authority.
