...
local_dir=$repo/results/phase7/child_soa_trial_2026-09-09/selector
artifact_dir=/home/icly/Documents/tetris_ai_runner_results/phase7/child_soa_trial_2026-09-09/selector_artifacts
normal=$artifact_dir/tetris_profile_normal
soa=$artifact_dir/tetris_profile_child_soa
params=$repo/artifacts/frozen_29d.bin
count_verdict=$repo/results/phase7/child_soa_trial_2026-09-09/count_attempt3/PARENT_VERDICT.md
...
if ! git merge-base --is-ancestor b1ab3bc "$git_head" || test -n "$(git status --porcelain --untracked-files=no)"; then
...
verify_hash 94a95df71e382d59d216b7be8cc4ce5458a99a84f60aae36d154c9963878062d "$count_verdict"

if test "$(stat -c %a "$normal")" != 444 || test "$(stat -c %a "$soa")" != 444; then
