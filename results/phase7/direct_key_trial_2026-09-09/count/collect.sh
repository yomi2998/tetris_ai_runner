...
local_dir=$repo/results/phase7/direct_key_trial_2026-09-09/count
external_dir=/home/icly/Documents/tetris_ai_runner_results/phase7/direct_key_trial_2026-09-09/trace
normal=$repo/out/build/linux-gcc-self-release/tetris_profile_value
soa=$repo/out/build/linux-gcc-self-release/tetris_profile_direct_key
partition_normal=$repo/out/build/linux-gcc-self-release/candidate_partition
partition_soa=$repo/out/build/linux-gcc-self-release/candidate_partition_direct_key
...
if ! git merge-base --is-ancestor e0da804 "$git_head" || test -n "$(git status --porcelain --untracked-files=no)"; then
...
verify_hash 4642f85a76e6f04635cca482c9654f3e465d266ae6e43441d0c539776da83fd8 "$partition_soa"
verify_hash ea95ba584f4eb5a7234bf0fbdd68fb422e00e29d13373e4df9e6b9ea2ca98037 "$params"
verify_hash 5c40bf19b78b435396719857c24a471310618c52b87281414a7eadc4cc04a27f "$repo/results/phase7/direct_key_trial_2026-09-09/validation/prerequisite_tests_2026-09-09.txt"
